...
func TestGetConfigDefaultTemplate(t *testing.T) {
	for i := range countOfConfigTests {
		...
		allAddValueConfigTest[i](optionalFile, DEFAULT_LOG_FORMATTER_PARAMETER_PROPERTY_NAME+TEMPLATE_PARAMETER, "time: $time severity: $sev message: $msg")
		allAddValueConfigTest[i](optionalFile, DEFAULT_LOG_FORMATTER_PARAMETER_PROPERTY_NAME+TEMPLATE_CORRELATION_PARAMETER, "time: $time severity: $sev correlation: $corr message: $msg")
		allAddValueConfigTest[i](optionalFile, DEFAULT_LOG_FORMATTER_PARAMETER_PROPERTY_NAME+TEMPLATE_CUSTOM_PARAMETER, "time: $time severity: $sev message: $msg $cust_k1: $cust_v1[%s] $cust_k2: $cust_v2[%d] $cust_k3: $cust_v3[%t]")
		allAddValueConfigTest[i](optionalFile, DEFAULT_LOG_FORMATTER_PARAMETER_PROPERTY_NAME+TIME_LAYOUT_PARAMETER, time.RFC1123Z)
		allAddValueConfigTest[i](optionalFile, DEFAULT_LOG_FORMATTER_PARAMETER_PROPERTY_NAME+TEMPLATE_CALLER_PARAMETER, "time: $time severity: $sev caller:$caller file:$file line:$line message: $msg")
		allAddValueConfigTest[i](optionalFile, DEFAULT_LOG_FORMATTER_PARAMETER_PROPERTY_NAME+TEMPLATE_CALLER_CORRELATION_PARAMETER, "time: $time severity: $sev correlation: $corr caller:$caller file:$file line:$line message: $msg")
		allAddValueConfigTest[i](optionalFile, DEFAULT_LOG_FORMATTER_PARAMETER_PROPERTY_NAME+TEMPLATE_CALLER_CUSTOM_PARAMETER, "time: $time severity: $sev caller:$caller file:$file line:$line message: $msg $cust_k1: $cust_v1[%s] $cust_k2: $cust_v2[%d] $cust_k3: $cust_v3[%t]")
		allAddValueConfigTest[i](optionalFile, DEFAULT_LOG_FORMATTER_PARAMETER_PROPERTY_NAME+STATIC_ENV_NAMES, "param1,param2")
		allPostInitConfigTest[i](optionalFile)
		...
		testutil.AssertEquals("time: $time severity: $sev message: $msg", result.Formatter[0].(TemplateFormatterConfig).Template, t, "result.formatter[0].template")
		testutil.AssertFalse(result.Formatter[0].(TemplateFormatterConfig).IsDefaultTemplate, t, "result.formatter[0].IsDefaultTemplate")
		testutil.AssertEquals("time: $time severity: $sev correlation: $corr message: $msg", result.Formatter[0].(TemplateFormatterConfig).CorrelationIdTemplate, t, "result.formatter[0].correlationIdTemplate")
		...
		testutil.AssertEquals("time: $time severity: $sev message: $msg $cust_k1: $cust_v1[%s] $cust_k2: $cust_v2[%d] $cust_k3: $cust_v3[%t]", result.Formatter[0].(TemplateFormatterConfig).CustomTemplate, t, "result.formatter[0].customTemplate")
		...
		testutil.AssertEquals(time.RFC1123Z, result.Formatter[0].TimeLayout(), t, "result.formatter[0].TimeLayout()")
		testutil.AssertEquals("time: $time severity: $sev caller:$caller file:$file line:$line message: $msg", result.Formatter[0].(TemplateFormatterConfig).CallerTemplate, t, "result.formatter[0].CallerTemplate")
		...
		testutil.AssertEquals("time: $time severity: $sev correlation: $corr caller:$caller file:$file line:$line message: $msg", result.Formatter[0].(TemplateFormatterConfig).CallerCorrelationIdTemplate, t, "result.formatter[0].CallerCorrelationIdTemplate")
		...
		testutil.AssertEquals("time: $time severity: $sev caller:$caller file:$file line:$line message: $msg $cust_k1: $cust_v1[%s] $cust_k2: $cust_v2[%d] $cust_k3: $cust_v3[%t]", result.Formatter[0].(TemplateFormatterConfig).CallerCustomTemplate, t, "result.formatter[0].CallerCustomTemplate")
...
func TestGetConfigDefaultTemplateInactiveSequenceWithoutParameter(t *testing.T) {
	for i := range countOfConfigTests {
		...
		testutil.AssertEquals("", result.Formatter[0].PackageParameter(), t, "result.formatter[0].PackageParameter()")
		testutil.AssertEquals(FORMATTER_TEMPLATE, result.Formatter[0].FormatterType(), t, "result.formatter[0].FormatterType()")
		testutil.AssertEquals("[$time] $sev: $msg", result.Formatter[0].(TemplateFormatterConfig).Template, t, "result.formatter[0].template")
		testutil.AssertTrue(result.Formatter[0].(TemplateFormatterConfig).IsDefaultTemplate, t, "result.formatter[0].IsDefaultTemplate")
		testutil.AssertEquals("[$time] $sev $corr: $msg", result.Formatter[0].(TemplateFormatterConfig).CorrelationIdTemplate, t, "result.formatter[0].correlationIdTemplate")
		...
		testutil.AssertEquals("[$time] $sev: $msg", result.Formatter[0].(TemplateFormatterConfig).CustomTemplate, t, "result.formatter[0].customTemplate")
		...
		testutil.AssertEquals(time.RFC3339, result.Formatter[0].TimeLayout(), t, "result.formatter[0].TimeLayout()")
		testutil.AssertEquals("[$time] $sev $func($file.$line): $msg", result.Formatter[0].(TemplateFormatterConfig).CallerTemplate, t, "result.formatter[0].CallerTemplate")
		...
		testutil.AssertEquals("[$time] $sev $corr $func($file.$line): $msg", result.Formatter[0].(TemplateFormatterConfig).CallerCorrelationIdTemplate, t, "result.formatter[0].CallerCorrelationIdTemplate")
		...
		testutil.AssertEquals("[$time] $sev $func($file.$line): $msg", result.Formatter[0].(TemplateFormatterConfig).CallerCustomTemplate, t, "result.formatter[0].CallerCustomTemplate")
...
func TestGetConfigDefaultTemplateActiveSequenceWithoutParameter(t *testing.T) {
	for i := range countOfConfigTests {
		...
		testutil.AssertEquals("", result.Formatter[0].PackageParameter(), t, "result.formatter[0].PackageParameter()")
		testutil.AssertEquals(FORMATTER_TEMPLATE, result.Formatter[0].FormatterType(), t, "result.formatter[0].FormatterType()")
		testutil.AssertEquals("[$time] $seq $sev: $msg", result.Formatter[0].(TemplateFormatterConfig).Template, t, "result.formatter[0].template")
		testutil.AssertTrue(result.Formatter[0].(TemplateFormatterConfig).IsDefaultTemplate, t, "result.formatter[0].IsDefaultTemplate")
		testutil.AssertEquals("[$time] $seq $sev $corr: $msg", result.Formatter[0].(TemplateFormatterConfig).CorrelationIdTemplate, t, "result.formatter[0].correlationIdTemplate")
		testutil.AssertTrue(result.Formatter[0].(TemplateFormatterConfig).IsDefaultCorrelationIdTemplate, t, "result.formatter[0].IsDefaultCorrelationIdTemplate")
		testutil.AssertEquals("[$time] $seq $sev: $msg", result.Formatter[0].(TemplateFormatterConfig).CustomTemplate, t, "result.formatter[0].customTemplate")
		testutil.AssertTrue(result.Formatter[0].(TemplateFormatterConfig).IsDefaultCustomTemplate, t, "result.formatter[0].IsDefaultCustomTemplate")
		testutil.AssertEquals(time.RFC3339, result.Formatter[0].TimeLayout(), t, "result.formatter[0].TimeLayout()")
		testutil.AssertEquals("[$time] $seq $sev $func($file.$line): $msg", result.Formatter[0].(TemplateFormatterConfig).CallerTemplate, t, "result.formatter[0].CallerTemplate")
		testutil.AssertTrue(result.Formatter[0].(TemplateFormatterConfig).IsDefaultCallerTemplate, t, "result.formatter[0].IsDefaultCallerTemplate")
		testutil.AssertEquals("[$time] $seq $sev $corr $func($file.$line): $msg", result.Formatter[0].(TemplateFormatterConfig).CallerCorrelationIdTemplate, t, "result.formatter[0].CallerCorrelationIdTemplate")
		testutil.AssertTrue(result.Formatter[0].(TemplateFormatterConfig).IsDefaultCallerCorrelationIdTemplate, t, "result.formatter[0].IsDefaultCallerCorrelationIdTemplate")
		testutil.AssertEquals("[$time] $seq $sev $func($file.$line): $msg", result.Formatter[0].(TemplateFormatterConfig).CallerCustomTemplate, t, "result.formatter[0].CallerCustomTemplate")
		testutil.AssertTrue(result.Formatter[0].(TemplateFormatterConfig).IsDefaultCallerCustomTemplate, t, "result.formatter[0].IsDefaultCallerCustomTemplate")
		testutil.AssertEquals(0, len(result.Formatter[0].GetCommon().EnvNamesToLog), t, "len(result.Formatter[0].GetCommon().EnvNamesToLog)")
	}
}
...
func TestGetConfigPackageTemplate(t *testing.T) {
	...
	for i := range countOfConfigTests {
		...
		allAddValueConfigTest[i](optionalFile, PACKAGE_LOG_FORMATTER_PARAMETER_PROPERTY_NAME+packageName+TEMPLATE_PARAMETER, "time: $time severity: $sev message: $msg")
		allAddValueConfigTest[i](optionalFile, PACKAGE_LOG_FORMATTER_PARAMETER_PROPERTY_NAME+packageName+TEMPLATE_CORRELATION_PARAMETER, "time: $time severity: $sev correlation: $corr message: $msg")
		allAddValueConfigTest[i](optionalFile, PACKAGE_LOG_FORMATTER_PARAMETER_PROPERTY_NAME+packageName+TEMPLATE_CUSTOM_PARAMETER, "time: $time severity: $sev message: $msg $cust_k1: $cust_v1[%s] $cust_k2: $cust_v2[%d] $cust_k3: $cust_v3[%t]")
		...
		testutil.AssertEquals("time: $time severity: $sev message: $msg", result.Formatter[1].(TemplateFormatterConfig).Template, t, "result.formatter[1].template")
		testutil.AssertFalse(result.Formatter[1].(TemplateFormatterConfig).IsDefaultTemplate, t, "result.formatter[1].IsDefaultTemplate")
		testutil.AssertEquals("time: $time severity: $sev correlation: $corr message: $msg", result.Formatter[1].(TemplateFormatterConfig).CorrelationIdTemplate, t, "result.formatter[1].correlationIdTemplate")
		...
		testutil.AssertEquals("time: $time severity: $sev message: $msg $cust_k1: $cust_v1[%s] $cust_k2: $cust_v2[%d] $cust_k3: $cust_v3[%t]", result.Formatter[1].(TemplateFormatterConfig).CustomTemplate, t, "result.formatter[1].customTemplate")
		...
		testutil.AssertEquals("[$time] $seq $sev $func($file.$line): $msg", result.Formatter[1].(TemplateFormatterConfig).CallerTemplate, t, "result.formatter[1].CallerTemplate")
		...
		testutil.AssertEquals("[$time] $seq $sev $corr $func($file.$line): $msg", result.Formatter[1].(TemplateFormatterConfig).CallerCorrelationIdTemplate, t, "result.formatter[1].CallerCorrelationIdTemplate")
		...
		testutil.AssertEquals("[$time] $seq $sev $func($file.$line): $msg", result.Formatter[1].(TemplateFormatterConfig).CallerCustomTemplate, t, "result.formatter[1].CallerCustomTemplate")
...
func TestGetConfigPackageTemplateInherit(t *testing.T) {
	...
	for i := range countOfConfigTests {
		...
		for j := range 2 {
			...
			testutil.AssertEquals("time: $time severity: $sev message: $msg", result.Formatter[j].(TemplateFormatterConfig).Template, t, "result.formatter[j].template")
			testutil.AssertFalse(result.Formatter[j].(TemplateFormatterConfig).IsDefaultTemplate, t, "result.formatter[j].IsDefaultTemplate")
			testutil.AssertEquals("time: $time severity: $sev correlation: $corr message: $msg", result.Formatter[j].(TemplateFormatterConfig).CorrelationIdTemplate, t, "result.formatter[j].correlationIdTemplate")
			...
			testutil.AssertEquals("time: $time severity: $sev message: $msg $cust_k1: $cust_v1[%s] $cust_k2: $cust_v2[%d] $cust_k3: $cust_v3[%t]", result.Formatter[j].(TemplateFormatterConfig).CustomTemplate, t, "result.formatter[j].customTemplate")
			...
			testutil.AssertEquals("time: $time severity: $sev caller:$caller file:$file line:$line message: $msg", result.Formatter[j].(TemplateFormatterConfig).CallerTemplate, t, "result.formatter[j].CallerTemplate")
			...
			testutil.AssertEquals("time: $time severity: $sev correlation: $corr caller:$caller file:$file line:$line message: $msg", result.Formatter[j].(TemplateFormatterConfig).CallerCorrelationIdTemplate, t, "result.formatter[j].CallerCorrelationIdTemplate")
			...
			testutil.AssertEquals("time: $time severity: $sev caller:$caller file:$file line:$line message: $msg $cust_k1: $cust_v1[%s] $cust_k2: $cust_v2[%d] $cust_k3: $cust_v3[%t]", result.Formatter[j].(TemplateFormatterConfig).CallerCustomTemplate, t, "result.formatter[j].CallerCustomTemplate")
...
func TestGetConfigFromFileButAllCommentOut(t *testing.T) {
	...
	propertiesFileAddValueConfigTest(propertiesFile, DEFAULT_LOG_FORMATTER_PARAMETER_PROPERTY_NAME+TEMPLATE_PARAMETER, "time: $time severity: $sev message: $msg")
	propertiesFileAddValueConfigTest(propertiesFile, DEFAULT_LOG_FORMATTER_PARAMETER_PROPERTY_NAME+TEMPLATE_CORRELATION_PARAMETER, "time: $time severity: $sev correlation: $corr message:$msg")
	propertiesFileAddValueConfigTest(propertiesFile, DEFAULT_LOG_FORMATTER_PARAMETER_PROPERTY_NAME+TEMPLATE_CUSTOM_PARAMETER, "time: $time severity: $sev message: $msg $cust_k1: $cust_v1[%s] $cust_k2: $cust_v2[%d] $cust_k3: $cust_v3[%t]")
	propertiesFileAddValueConfigTest(propertiesFile, DEFAULT_LOG_FORMATTER_PARAMETER_PROPERTY_NAME+TIME_LAYOUT_PARAMETER, time.RFC1123Z)
	fmt.Fprintln(propertiesFile, "*/")
	fmt.Fprintln(propertiesFile, "")
