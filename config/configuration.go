...
const (
	...
	DEFAULT_DELIMITER                            = " - "
	DEFAULT_TEMPLATE                             = "[$time] $sev: $msg"
	DEFAULT_CORRELATION_TEMPLATE                 = "[$time] $sev $corr: $msg"
	DEFAULT_CUSTOM_TEMPLATE                      = "[$time] $sev: $msg"
	DEFAULT_CALLER_TEMPLATE                      = "[$time] $sev $func($file.$line): $msg"
	DEFAULT_CALLER_CORRELATION_TEMPLATE          = "[$time] $sev $corr $func($file.$line): $msg"
	DEFAULT_CALLER_CUSTOM_TEMPLATE               = "[$time] $sev $func($file.$line): $msg"
	DEFAULT_SEQUENCE_TEMPLATE                    = "[$time] $seq $sev: $msg"
	DEFAULT_SEQUENCE_CORRELATION_TEMPLATE        = "[$time] $seq $sev $corr: $msg"
	DEFAULT_SEQUENCE_CUSTOM_TEMPLATE             = "[$time] $seq $sev: $msg"
	DEFAULT_SEQUENCE_CALLER_TEMPLATE             = "[$time] $seq $sev $func($file.$line): $msg"
	DEFAULT_SEQUENCE_CALLER_CORRELATION_TEMPLATE = "[$time] $seq $sev $corr $func($file.$line): $msg"
