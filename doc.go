...
DELIMITER: The record information will be appended and delimited with a given sign. The default value of the delimiter is “ - ”. It can be configured by setting “TYPEWRITER_LOG_FORMATTER_PARAMETER”.
...
The keys of the custom value map will be used 1:1. The properties can be set via “TYPEWRITER_LOG_FORMATTER_PARAMETER_<x>” where <x> has to be replaced by the following integers.
